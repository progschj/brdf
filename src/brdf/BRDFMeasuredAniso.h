...
public:
    BRDFMeasuredAniso();
    virtual ~BRDFMeasuredAniso();

    bool loadAnisoData( const char* filename );

protected:

    virtual void initGL();
    virtual std::string getBRDFFunction() { return brdfFunction; }
